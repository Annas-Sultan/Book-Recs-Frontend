  ...
  return (
    <section className="mx-auto max-w-2xl px-4 py-8 lg:max-w-7xl lg:px-8">
      ...
      <form onSubmit={onSubmit} className="rounded-md bg-gray-400 p-2">
        ...
        <button type="submit" className="mt-2 rounded-full bg-white p-2" disabled={isLoading}>
...
const Spinner = () => (
  // yoinked straight from https://flowbite.com/docs/components/spinner/#default-spinner
  <div role="status">
    <svg
      aria-hidden="true"
      className="mr-2 h-6 w-8 animate-spin fill-blue-600 text-gray-200 dark:text-gray-600"
      viewBox="0 0 100 101"
      fill="none"
